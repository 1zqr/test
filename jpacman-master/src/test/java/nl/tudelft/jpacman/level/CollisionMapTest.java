...
/**
 * 用于实现CollisionMap类的类的测试。（同时测试PlayerCollisions和DefaultPlayerInteractionMap）
 */
public abstract class CollisionMapTest {
    ...
    /**
     * 实现PlayerCollisions和DefaultPlayerInteractionMap的不同初始化
     */
    @BeforeEach
    abstract void init();
    ...
    void testPlayerGhost() {
        ...
        //验证玩家与幽灵相碰撞时，验证collidedWithAGhost（）方法至少发生一次，其功能是用来更新玩家分数
